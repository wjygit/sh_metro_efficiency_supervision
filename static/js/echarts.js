	 ...
	 */
	    ...
	    var GlobalModel = Model.extend({
	        ...
	        mergeOption: function (newOption) {
	            ...
	            // 濡傛灉涓嶅瓨鍦ㄥ搴旂殑 component model 鍒欑洿鎺� merge
...
/***/ function(module, exports) {
	 ...
	 */
	    ...
	    /**
	     * find a 鈥渘ice鈥� number approximately equal to x. Round the number if round = true, take ceiling if round = false
	     * The primary observation is that the 鈥渘icest鈥� numbers in decimal are 1, 2, and 5, and all power-of-ten multiples of these numbers.
	     * @param  {number} val
	     * @param  {boolean} round
	     * @return {number}
	     */
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Global defines
	    ...
	    var instances = {};    // ZRender瀹炰緥map绱㈠紩
	    ...
	    var ZRender = function(id, dom, opts) {
	        ...
	        // 淇敼 storage.delFromMap, 姣忔鍒犻櫎鍏冪礌涔嬪墠鍒犻櫎鍔ㄧ敾
	        // FIXME 鏈夌偣ugly
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    Handler.prototype = {
	         ...
	         *
	         * @private
	         * @param {Object} targetEl 鐩爣鍥惧舰鍏冪礌
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	    ...
	    Storage.prototype = {
	         ...
	         * @param {string|Array.<string>} [elId] 濡傛灉涓虹┖娓呯┖鏁翠釜Storage
	         */
...
/***/ function(module, exports, __webpack_require__) {
	...
	// https://developer.apple.com/videos/wwdc2014/#236
	    ...
	    Animation.prototype = {
	        ...
	        /**
	         * 瀵逛竴涓洰鏍囧垱寤轰竴涓猘nimator瀵硅薄锛屽彲浠ユ寚瀹氱洰鏍囦腑鐨勫睘鎬т娇鐢ㄥ姩鐢�
	         * @param  {Object} target
	         * @param  {Object} options
	         * @param  {boolean} [options.loop=false] 鏄惁寰幆鎾斁鍔ㄧ敾
	         * @param  {Function} [options.getter=null]
	         *         濡傛灉鎸囧畾getter鍑芥暟锛屼細閫氳繃getter鍑芥暟鍙栧睘鎬у€�
	         * @param  {Function} [options.setter=null]
	         *         濡傛灉鎸囧畾setter鍑芥暟锛屼細閫氳繃setter鍑芥暟璁剧疆灞炴€у€�
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	     ...
	     * @param {string} type dom type锛宻uch as canvas, div etc.
	    ...
	    function createDom(id, type, painter, dpr) {
	        ...
	        // id涓嶄綔涓虹储寮曠敤锛岄伩鍏嶅彲鑳介€犳垚鐨勯噸鍚嶏紝瀹氫箟涓虹鏈夊睘鎬�
...
/***/ function(module, exports, __webpack_require__) {
	...
	var factory = exports;
	    ...
	    // 渚濊禆 GridModel, AxisModel 鍋氶澶勭悊
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    axisHelper.getAxisLabelInterval = function (tickCoords, labels, font, isAxisHorizontal) {
	        // FIXME
	        // 涓嶅悓瑙掔殑axis鍜宭abel锛屼笉鍙槸horizontal鍜寁ertical.
